...
public abstract class MCCEnchantment {
    ...
    public static void registerEnchantment(@NotNull MCCEnchantment enchantment) {
        ...
        int id = IRegistry.W.a(CraftEnchantment.getRaw(org.bukkit.enchantments.Enchantment.getByKey(enchantment.key)));
        if (id == -1) id = IRegistry.W.a(craftMCCEnchantment.getHandle());

        if (id == -1) {

            IRegistry.a(IRegistry.W, enchantment.key.getKey(), craftMCCEnchantment.getHandle());
        ...
        try {
            ...
            RegistryMaterials<Enchantment> enchantments = ((RegistryMaterials<Enchantment>) IRegistry.W);
            ResourceKey<Enchantment> resourceKey = ResourceKey.a(IRegistry.W.n(), new MinecraftKey(enchantment.key.getKey()));
    ...
    public static void registerMinecraftEnchantments(JavaPlugin plugin) {
        ...
        try {
            ...
            RegistryMaterials<Enchantment> enchantments = (RegistryMaterials<Enchantment>) IRegistry.W;
            Field isFrozen = enchantments.getClass().getDeclaredField("ca");
